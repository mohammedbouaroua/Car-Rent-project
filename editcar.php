...
<body>
    <div class="form-container">
        <h2><?= ui_icon('edit') ?> Modifier la voiture</h2>
        ...
        <form action="updatecar.php" method="post" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input type="text" name="license_plate" value="<?php echo htmlspecialchars($car['license_plate'], ENT_QUOTES, 'UTF-8'); ?>" required>
            </div>
            ...
            <div class="form-group">
                ...
                <select name="fuel_type">
                    ...
                    <option value="electric" <?php echo $car['fuel_type'] == 'electric' ? 'selected' : ''; ?>>Electrique</option>
            ...
            <div class="form-group">
                ...
                <?php if ($car['photo']): ?>
                    <img src="<?php echo $car['photo']; ?>" width="100" alt="Photo actuelle">
                <?php endif; ?>
            ...
            <div class="form-group">
                ...
                <textarea name="description" rows="4"><?php echo htmlspecialchars($car['description'], ENT_QUOTES, 'UTF-8'); ?></textarea>
            </div>
    ...
    <div class="button-container">
        <a href="allcars.php"><?= ui_icon('arrow-left') ?> Retour a la flotte</a>
    </div>
</body>
</html>
