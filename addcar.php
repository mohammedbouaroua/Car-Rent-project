...
<body>
        ...
        <form action="addcar_action.php" method="post" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input type="text" id="model" name="model" required 
                       placeholder="Ex: Clio, Megane, Serie 3" maxlength="50">
            </div>
            ...
            <div class="form-group">
                ...
                <input type="text" id="license_plate" name="license_plate" required 
                       placeholder="Ex: AB-123-CD" maxlength="20">
            </div>
            ...
            <div class="form-group">
                ...
                <div class="hint">Formats acceptés: PNG, JPG, JPEG. Max: 5MB</div>
            </div>
            ...
            <div class="form-group">
                ...
                <textarea id="description" name="description" 
                         placeholder="Caractéristiques, options, etc." rows="4"></textarea>
            </div>
    ...
    <div class="button-container">
        <a href="allcars.php" class="show">Voir toutes les voitures</a>
    </div>
</body>
</html>
